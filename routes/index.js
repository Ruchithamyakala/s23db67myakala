...
res.render('index', { title: 'groceries App', user : req.user });
});
router.get('/register', function(req, res) {
res.render('register', { title: 'groceries App Registration'});
});
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'groceries App Login', user : req.user });
  });
